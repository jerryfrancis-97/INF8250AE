...
def agent_update_step( 
    ...
    # Uncomment & use this code block for BEST PERFORMING DQN AGENT, Ques 3.b.
    #improvement - global norm gradient clipping
    # max_norm = 1.0
    # total_norm = jnp.sqrt(sum(jnp.sum(g ** 2) for g in jax.tree_util.tree_leaves(dqn_grad)))
    # clip_coeff = jnp.minimum(1.0, max_norm / (total_norm + 1e-6))
    # dqn_grad = jax.tree_map(lambda g: g * clip_coeff, dqn_grad)
